...
/**
 * Pastes a whole list of Riot IDs at once, in any format (see
 * `matchRosterLines`). Lines that could not be matched are listed, so nothing
 * is silently skipped.
 */
  ...
  return (
    <form action={formAction} className="flex flex-col gap-3 border-2 border-line bg-surface p-4">
      ...
      <textarea
        ...
        rows={6}
        spellCheck={false}
        placeholder={'Equipo 15, Dario Ferro, DarioFerro#LAN\nGregorio Aguilar; ElGoyo#ARG1'}
