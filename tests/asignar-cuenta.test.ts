...
describe('asignar una cuenta a un inscripto', () => {
  ...
  beforeEach(async () => {
    ...
    for (const [index, nombre] of ['Paula Ibarra', 'Elena Sosa'].entries()) {
  ...
  it('empareja un nick cargado a mano con su dueño', async () => {
    const result = await asignar(inscripto.get('Paula Ibarra')!, cuenta.get('LIDE CHAMPION')!)
  ...
  it('lo deja verse en roster_status, con la cuenta y sin partidas', async () => {
    await asignar(inscripto.get('Elena Sosa')!, cuenta.get('Pachu')!)
  ...
  it('no acepta una cuenta de otro equipo', async () => {
    const result = await asignar(inscripto.get('Paula Ibarra')!, cuenta.get('Azael')!)
  ...
  it('no le saca la cuenta a otro inscripto: dice de quién es', async () => {
    await asignar(inscripto.get('Paula Ibarra')!, cuenta.get('Pachu')!)
    const result = await asignar(inscripto.get('Elena Sosa')!, cuenta.get('Pachu')!)
  ...
  it('desasigna con null, que es como se deshace un emparejado equivocado', async () => {
    await asignar(inscripto.get('Paula Ibarra')!, cuenta.get('Pachu')!)
    const result = await asignar(inscripto.get('Paula Ibarra')!, null)
    ...
    const otra = await asignar(inscripto.get('Elena Sosa')!, cuenta.get('Pachu')!)
